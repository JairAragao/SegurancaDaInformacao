...
Welcome <?php echo $_POST["controlador"]; ?><br>
Your email address is: <?php echo $_POST["operador"]; ?>
...
<body>
        <div id="agente_trat">
            ...
            <input type="text" name="controlador" autofocus placeholder = <?php echo $_POST["controlador"]; ?> disabled><br><br>

            # Operador * <br>
            <input type="text" name="operador" placeholder = <?php echo $_POST["operador"]; ?> autofocus><br><br>
